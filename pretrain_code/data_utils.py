...
def get_ImageNetdataloaders(train_data_path, test_data_path):
    ...
    cla_dict = np.load("/home/***/code/src/code and baselines/dataset/imagenet2012/label_dict.npy",allow_pickle=True).item()
...
def get_serverdataloader(server_test_path):
    ...
    cla_dict = np.load("/home/***/code/src/code and baselines/dataset/imagenet2012/label_dict.npy").item()
    #print(lablename_list[0])
    for i in range(len(lablename_list)):
...
train_data_path = "/home/***/code/src/code and baselines/dataset/imagenet2012/fed_data/client_12non-iid_alpha1.5/client_0/train"
test_data_path = "/home/***/code/src/code and baselines/dataset/imagenet2012/fed_data/client_12non-iid_alpha1.5/client_0/test"  
...
server_test_path = "/home/***/code/src/code and baselines/dataset/imagenet2012/val"
