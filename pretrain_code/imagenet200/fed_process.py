...
meta_data = np.load("/home/***/code/src/code and baselines/dataset/imagenet2012/imagenet200/index_"+str(client_num)+"_alpha"+str(alpha)+".npy", 
                    allow_pickle=True).tolist()
all_image_path = Path("/home/***/code/src/code and baselines/dataset/imagenet2012/imagenet200/train")
...
folder_path = "/home/***/code/src/code and baselines/dataset/imagenet2012/imagenet200/fed_data/client_"+str(client_num)+"non-iid_"+str(alpha)
