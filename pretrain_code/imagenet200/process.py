...
folder_path = "./dataset/imagenet2012/train/"
...
source_dir = "./dataset/imagenet2012/fed_data"
output_filename = "./dataset/imagenet2012/fed_data.tar"
make_tarfile(output_filename, source_dir)'''

'''
import os
import numpy as np
train_data_path = "./dataset/imagenet2012/train"
...
for name in lablename_list:
    ...
    label += 1
print(cla_dict)
np.save("./dataset/imagenet2012/label_dict.npy", cla_dict)'''


import os
import shutil
import sys
tiny_imagenet_path = "./dataset/tiny-imagenet_1.5/train"
all_train_path = "./EXP/data/ImageNet/train"
all_val_path = "./EXP/data/ImageNet/val"

tiny_train_path = "./dataset/imagenet2012/imagenet200/train"
tiny_val_path = "./dataset/imagenet2012/imagenet200/val"
