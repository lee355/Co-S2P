...
class ScatterAndGather_fedrolex(Controller):
    def __init__(
        ...
        self.test_loader,img_size = data_utils.get_serverdataloader('/home/nvidia/val')
        ...
        torch.save(self.server.global_model.model.state_dict(), f'/home/nvidia/model/model_params_test.pth')
        self.param_idx = None
    ...
    def control_flow(self, abort_signal: Signal, fl_ctx: FLContext) -> None:
        try:
            ...
            while self._current_round < self._start_round + self._num_rounds:
                ...
                self.server.aggregate_weights(self.client_w,self._current_round)
    ...
    def _accept_train_result(self, client_name: str, result: Shareable, fl_ctx: FLContext) -> bool:
        ...
        self.client_w[client_name]= {k: torch.as_tensor(v,device=self.device) for k, v in from_shareable(result).data.items()}
    ...
    def _accept_get_model_rate_result(self, client_name: str, result: Shareable, fl_ctx: FLContext) -> bool:
        ...
        #self.log_info(fl_ctx,f"model_rate{from_shareable(result).data['model_rate']}ooooooooooooooooooooooooooo")
