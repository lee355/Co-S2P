...
class Ours_c(Executor):
    ...
    def _get_model_weights(self) -> Shareable: 
        ...
        gradients_and_round={"receive_round": receive_round,'train_time' : train_time}
        outgoing_dxo = DXO(
    ...
    def _local_test_then_train(self, fl_ctx, weights, abort_signal):
        if self._current_round != 0:
            ...
            np.save(f'/home/***/model_local/client_1/result/loss.npy', self.loss_result)
            np.save(f'/home/***/model_local/client_1/result/top_1.npy', self.top_1_result)
            np.save(f'/home/***/model_local/client_1/result/f1_score.npy', self.f1_score_result)
            np.save(f'/home/***/model_local/client_1/result/top_5.npy', self.top_5_result)   
        ...
        if self._current_round % 5 == 0 :
                torch.save(self.client.local_weight_model.model.state_dict(),f'/home/***/model_local/client_1/model/model_params_{self._current_round}.pth')
