...
try:
    import jtop
    print('oooooooooooooooooooooooooooooooooooooooooooooooooooooosssssssssssssssssss')
    from utils import get_local_batch_size,get_local_model_rate
    print('oooooooooooooooooooooooooooooooooooooooooooooooooooooosssssssssssssssssss')
    local_bs = get_local_batch_size()
    print('iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii')
    bs = int(local_bs * 3.0)
    print('uiousaioduaoisudoiaudoias')
...
def get_model_rate():
    print("ksdkggkkghskgsddkksdkggkkghskgsddk")
    print(model_rate)
    print("ksdkggkkghskgsddk")
    return model_rate
