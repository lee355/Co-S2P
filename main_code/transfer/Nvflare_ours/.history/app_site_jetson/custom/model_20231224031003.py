...
def get_client_model(drop, training_mode, img_size, num_classes, embed_dim, transformer_depth, transformer_head, mlp_dim, device, segment_mask, self_distillation, lr, weight_decay, no_prox, model_rate=1):
