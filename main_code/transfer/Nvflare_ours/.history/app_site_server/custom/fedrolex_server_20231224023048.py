...
class ScatterAndGather_fedrolex(Controller):
    def __init__(
        ...
        self.test_loader,img_size = data_utils.get_serverdataloader('/home/xugw/fed_data/client_7non-iid_1.5/val')
    ...
    def control_flow(self, abort_signal: Signal, fl_ctx: FLContext) -> None:
        try:
            ...
            while self._current_round < self._start_round + self._num_rounds:
                ...
                self.server.aggregate_gradients(self.client_w, self.param_idx, self._current_round)
