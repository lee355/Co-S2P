...
class ScatterAndGather_fedrolex(Controller):
    def __init__(
        ...
        self.test_loader,img_size = data_utils.get_serverdataloader('"/home/***/code/src/code and baselines/dataset/imagenet2012/imagenet200/fed_data/client_7non-iid_1.5/val')
