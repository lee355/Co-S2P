...
class Server:
    ...
    def __init__(self, test_data ,drop, num_classes , embed_dim , transformer_depth , transformer_head, mlp_dim ,img_size, model_rate=1, device=None):
        ...
        self.global_model = FedModel(drop, num_classes , embed_dim , transformer_depth , transformer_head, mlp_dim ,img_size, model_rate=1, device=None) 
        self.stale_steps = 0
    ...
    def aggregate_weights(self, local_parameters, n_roud):
                    ...
                    if 'weight' in parameter_type:
                        if v.dim() > 1:
                            ...
                            if 'embedding' in k.split('.')[-2]:
                                ...
                                roll = int((self.rounds* output_size / 16)) % output_size
