...
class Ours_c(Executor):
    ...
    def __init__(
        ...
        self.site2gpu={'site-0' : 4 , 'site-1' : 5,'site-2':0,'site-3':1,'site-4':2,'site-5':3,'site-6':4,'site-7':5,'site-8':6,'site-9':7,'site-10':6,'site-11':7,'site-12':8,'site-13':8,'site-14':9,'site-15':9}
        self.site2modelrate={'site-0' : 1.0 , 'site-1' : 1.0,'site-2':0.5,'site-3':0.5,'site-4':0.5,'site-5':0.5,'site-6':0.5,'site-7':0.5,'site-8':0.5,'site-9':0.5,'site-10':0.5,'site-11':0.5,'site-12':0.5,'site-13':0.25,'site-14':0.25,'site-15':0.25}
        self.loss_result = []
        self.top_1_result = []
        self.top_5_result = []
        ...
        try:
            if task_name == self._train_task_name:
                ...
                self.client = Client(self.drop, img_size, self.num_classes, self.embed_dim, self.mlp_dim, self.transformer_depth, self.transformer_head,
                                    ...
                                    self.weight_decay, self.no_prox, self.lr,
                                    self.train_loader, self.test_loader, self.self_distillation, ratio=self.model_rate, mask_round_ratio=self.mask_round_ratio, device=self.device)
    ...
    def _get_model_weights(self) -> Shareable: 
        ...
        client_gradients, receive_round = self.client.upload_mask()  #TODO
