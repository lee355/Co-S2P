...
class Server:
    ...
    def aggregate_gradients(self, sampled_mask, local_freq, num_params, client_idxs, n_roud):
        return self.sample_mask_aggregation(sampled_mask, local_freq, num_params, client_idxs, n_roud)

    def sample_mask_aggregation(self, sampled_mask, local_freq, num_params, client_idxs, n_roud):
        """
