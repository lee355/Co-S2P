...
class ScatterAndGather_Ours(Controller):
    ...
    def control_flow(self, abort_signal: Signal, fl_ctx: FLContext) -> None:
        try:
            ...
            while self._current_round < self._start_round + self._num_rounds:
                ...
                self.server.aggregate_gradients(self.client_w, self.client_freq, self.client_numparams,n_roud=self._current_round)
    ...
    def _accept_train_result(self, client_name: str, result: Shareable, fl_ctx: FLContext) -> bool:
        ...
        self.client_freq[client_name] = from_shareable(result).data['local_freq']
        self.client_numparams[client_name] = from_shareable(result).data['num_params']
