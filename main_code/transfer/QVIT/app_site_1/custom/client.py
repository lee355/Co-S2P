...
class Client:
    ...
    def __init__(self, drop, img_size, num_classes, embed_dim, mlp_dim, transformer_depth, transformer_head, 
                 ...
                 train_dataset, test_dataset, self_distillation,model_rate, mask_round_ratio, device):
        ...
        self.local_model = FedModel(drop=self.drop, img_size=self.img_size, num_classes=self.num_classes,
                                    ...
                                    self_distillation=self.self_distillation, model_rate=self.model_rate,
    ...
    def train_local(self, train_loader ,local_epoch):
        loss = self.local_model.train_weights(data_loader=train_loader , local_sub_epoch = local_epoch)
