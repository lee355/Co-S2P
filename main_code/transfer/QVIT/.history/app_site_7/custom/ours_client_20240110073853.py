...
class Ours_c(Executor):
    ...
    def __init__(
        ...
        root_path='/home/ly/fed_data/client_8non-iid_1.5/client_7'
    ...
    def _get_model_weights(self) -> Shareable: 
        ...
        client_gradients = self.client.upload_weight()
        gradients = {k: v.cpu().numpy() for k, v in client_gradients.items()}
        train_time = time.time()-self.since
        gradients_and_round={"gradients": gradients,'train_time' : train_time}
    ...
    def _local_test_then_train(self, fl_ctx, weights, abort_signal):
        ...
        self.client.local_model.model.load_state_dict(state_dict=weights, strict=False)

        self.client.train_local(self.train_loader)
        ...
        np.save(f'/home/ly/model_local/client_7/result/loss.npy', self.loss_result)
        np.save(f'/home/ly/model_local/client_7/result/top_1.npy', self.top_1_result)
        np.save(f'/home/ly/model_local/client_7/result/f1_score.npy', self.f1_score_result)
        np.save(f'/home/ly/model_local/client_7/result/top_5.npy', self.top_5_result)
