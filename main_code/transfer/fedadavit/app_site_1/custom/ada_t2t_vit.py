...
class AdaStepT2T_ViT(nn.Module):
    def __init__(self, img_size=224, tokens_type='performer', in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 norm_policy=False, use_t2t = False, patch_size=16,
                 ...
                 ada_token = True, ada_token_with_mlp=True, ada_token_start_layer=0, ada_token_pre_softmax=True, ada_token_detach_attn=True,  ada_token_detach_attn_at_mlp=False,
                 keep_layers = 1, 
